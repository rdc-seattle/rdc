...
define("DEF_ALERT","mpedsea@gmail.com");
...
else
{
        ...
        //
    if ($HOOK_DIR !== "")
        if (!@include("$HOOK_DIR/fmhookpreemail.inc.php"))
...
else
{
        ...
        //
    if ($HOOK_DIR !== "")
        if (!@include("$HOOK_DIR/fmhookprefinish.inc.php"))
    ...
    if (!$bGotGoodUrl)
    {
        ...
        else
        {
            ...
            //
        if ($HOOK_DIR !== "")
            if (!@include("$HOOK_DIR/fmhookpostfinish.inc.php"))
